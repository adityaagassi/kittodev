                ...
                <div class="pageheader">
                    <h2><i class="fa fa-barcode"></i> Cancel Transfers </h2>
                </div>
                <div class="contentpanel">
                    <div class="row">
                    	<div class="panel panel-default">
        					<div class="panel-body panel-body-nopadding">
        						<!-- <form id ="basicForm" class="form-horizontal form-bordered" method="post" action="{{ url('/transfers/cancel') }}"> -->
                    ...
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header modal-danger">
                                ...
                                <h4 class="modal-title-danger" id="titleModal">Transfer Gagal</h4>
                            </div>
                            <div class="modal-body modal-danger">
                                <div class="row">
                                    ...
                                    <div class="col-md-9" id="messageModal">
                                        <h4>Barcode tidak dapat di transfer karena belum di completion.</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                                <h3 class="modal-title">Transfer List</h3>
                            </div>
                            <div class="modal-body">
                                <div class="row" id="histories">
                                    <div class="col-md-12">
                                        <h3 id="totalTransfer" class="text-color-yamaha">30</h3>
				...
				<script>
						...
						$('#finish').on('click', function() {
						    ...
						    if (histories.length > 0) {
						        ...
						        for (var i = 0; i < histories.length; i++) {
						            ...
						            html += "<tr>";
						            html += "<td>" + ( i + 1 ) + "</td>";
						            html += "<td>" + history.transfer_barcode_number + "</td>";
		                            html += "<td>" + history.completion_description + "</td>";
						            html += "<td>" + history.lot + "</td>";
						            html += "</tr>";
						        }
						        $("#histories_table").append(html);
						        $("#totalTransfer").text("Total Transfer: " + histories.length);
						        openListModal();
						    }
						});
					...
					function cancelBarcode() {
					    ...
					    if (barcode.length > 0) {
					        ...
					        $.post('{{ url("/transfers/cancel") }}', data, function(result, status, xhr) {
					            console.log(status);
					            console.log(result);
					            console.log(xhr);
					            ...
					            if (xhr.status == 200) {
					                if (result.status) {
					                    ...
					                    jQuery.gritter.add({
					                        title: 'Cancel Transfer Berhasil Dilakukan!',
					                        text: "-",
					                    ...
					                    openErrorModal("Cancel Transfer Gagal!", image, "Barcode number " + barcode + " <br /> " + result.message);
					                ...
					                $('#barcode').val("");
					                $('#barcode').focus();
					                openErrorModal("Cancel Transfer Gagal!", "{{ url('images/image-stop.png') }}", "Tidak terhubung ke server");
					                var audio = new Audio('{{ url("sound/error.mp3") }}');
					                audio.play();
					            }
					        });
