                ...
                <div class="pageheader">
                    <h2><i class="fa fa-barcode"></i> Add After Repair </h2>
                </div>
							...
							<div class="panel panel-default">
								<div class="panel-body panel-body-nopadding">
									<div id="validationWizard" class="basic-wizard">
										...
										<form id="firstForm" class="form-horizontal form-bordered" method="POST" action="{{ url('/after-repairs/add') }}">
