                ...
                <div class="pageheader">
                    <h2><i class="fa fa-bars"></i> Adjustment Completion List</h2>
                </div>
								...
								<div class="panel panel-success">
									...
									<div class="panel-body">
										<div class="form-horizontal form-bordered">
										    ...
										    <div class="form-group">
										        <label class="col-sm-3">Reference Number</label>
										        <div class="col-sm-6">
										        	@if(isset($adjustments->reference_number))
										            {{ $adjustments->reference_number }}
										            @else
										            -
										            @endif
										        </div>
							...
							<div class="col-md-6">
								<div class="panel panel-success">
									...
									<div class="panel-body">
										...
										@else
											<center>Success completion adjustment is empty</center>
										@endif
									</div><!-- panel-body -->
								</div><!-- panel -->
							</div>
							...
							<div class="col-md-6">
								<div class="panel panel-danger">
									...
									<div class="panel-body">
										...
										@else
											<center>Failed completion adjustment is empty</center>
										@endif
									</div><!-- panel-body -->
								</div><!-- panel -->
							</div>
