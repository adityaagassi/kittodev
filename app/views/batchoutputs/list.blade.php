                ...
                <div class="pageheader">
                    <h2><i class="fa fa-tag"></i> Resume History </h2>
                </div>
          							...
          							<table class="table" id="table2">
										<thead>
              							...
              							<tbody>
											...
											<tr class="even">
											@endif
												<td><a href="{{ url("batchoutputs/$batchoutput->reference_file") }}">{{ $batchoutput->reference_file }}</a></td>
												<td>
													@if(in_array($batchoutput->category, Array("completion", "completion_adjustment", "completion_adjustment_excel", "completion_adjustment_manual", "completion_cancel", "completion_return", "completion_error")))
													Completion
													@else
													Transfer
													@endif
