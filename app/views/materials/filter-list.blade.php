                ...
                <div class="pageheader">
                    ...
                    <div class="breadcrumb-wrapper">
						<ol class="breadcrumb">
							<li>
								<a class="btn btn-black" href="{{ url("/materials/all/delete?" . $parameter)}}">Delete All</a>
							</li>
							<li>
								<a class="btn btn-success" href="javascript:void(0)" data-toggle="modal" data-target="#importModal" >Import</a>
							</li>
							<li>
								<a class="btn btn-success" href="{{ url("/materials/export?" . $parameter)}}">Export</a>
							</li>
							<li>
          							...
          							<table class="table" id="table2">
										<thead>
              							...
              							<tbody>
											...
											@if($index % 2 == 1)
											<tr class="odd" id="{{ $materials->id }}">
											@else
											<tr class="even" id="{{ $materials->id }}">
											@endif
												<td>
												...
												<td>
													<a href="{{ url("materials/$materials->id") }}">{{ $materials->location }}</a>
												</td>
												<td>
												...
												<td class="center">
													<center>
														<a href="javascript:void(0)"  data-toggle="modal" data-target="#myModal" onclick="deleteConfirmation('{{ $materials->id }}', '{{ $materials->material_number }}');">
															<span class="fa fa-times"></span>
														</a>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="{{ url("materials/$materials->id/edit?$parameter") }}">
                ...
                <script type="text/javascript">
					...
					jQuery('#modalDeleteButton').click(function() {
	                    $.get('{{ url("api/v1/materials") }}/' + selectedID + '/delete', function(result, status, xhr) {
