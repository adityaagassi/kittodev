                ...
                <div class="pageheader">
                	<h2><i class="fa fa-barcode"></i> Add Return </h2>
                </div>
                			...
                			<div class="panel panel-default">
                				<div class="panel-body panel-body-nopadding">
                					<div id="validationWizard" class="basic-wizard">
                						...
                						<form id="firstForm" class="form-horizontal form-bordered" method="POST" action="{{ url('/returns/add') }}">
                									...
                									<div class="form-group">
                										...
                										<div class="col-sm-6 ">
                											<select class="form-control chosen-select" name="receive_location" data-placeholder="Choose a Receive Location..." required>
                												...
                												<option value="{{ $receive_location->location }}">{{ $receive_location->location }}</option>
                												@endforeach
                												@endif
                											</select>
                										</div>
                									...
                									<div class="form-group">
                										...
                										<div class="col-sm-6">
                											<select class="form-control chosen-select" name="movement_type" data-placeholder="Choose a Movement Type..." required onchange="receivePlantOnChange();">
                												<option value=""></option>
                												<option value="9I4" selected>9I4</option>
                												<option value="9P2">9P2</option>
                											</select>
                										</div>
                									</div>
                								</div>
                ...
                <script>
				    ...
				    function nextForm() {
				    	...
				    	submit = ($('select[name="issue_location"]').val() != $('select[name="receive_location"]').val() && submit);
