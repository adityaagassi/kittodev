											...
											<div class="form-group">
												...
												<div class="col-sm-6 ">
													<div class="input-group">
														<input type="number" placeholder="Quantity" class="form-control" name="lot" value="0" required />
				...
				<script>
					...
					function scanBarcode() {
					    ...
					    if (barcode.length > 0) {
					        ...
					        $.post('{{ url("/transfers") }}', data, function(result, status, xhr) {
					            console.log(status);
					            console.log(result);
					            console.log(xhr);
					            ...
					            if (xhr.status == 200) {
					                if (result.status) {
					                    ...
					                    jQuery.gritter.add({
					                        title: 'Transfer Berhasil Dilakukan!',
					                        text: "-",
					                    ...
					                    openErrorModal("Transfer Gagal!", image, "Barcode number " + barcode + " <br /> " + result.message);
					                ...
					                $('#barcode').val("");
					                $('#barcode').focus();
					                openErrorModal("Transfer Gagal!", "{{ url('images/image-stop.png') }}", "Tidak terhubung ke server");
					                var audio = new Audio('{{ url("sound/error.mp3") }}');
					                audio.play();
					            }
					        });
