...
Route::get('/logout', array('as' => 'logout', 'uses' => 'UserController@userSignout'));
Route::get('/signout', array('as' => 'logout', 'uses' => 'UserController@userSignout'));
...
Route::group(array('before' => 'auth'), function() {
	...
	Route::get('/dashboard/{reference_file}', 'DashboardController@downloadGuide');
	Route::get('/turnover/filter', array('as' => 'filterturnover', 'uses' => 'TurnOverController@openFilterPage'));
	Route::get('/turnover/list', array('as' => 'filterlistturnover', 'uses' => 'TurnOverController@openFilterListPage'));
	...
	Route::get('/materials/filter', 'MaterialController@openFilterPage');
	Route::get('/materials/filter/list', array('as' => 'materials', 'uses' => 'MaterialController@openFilterListPage'));
	Route::get('/materials', array('as' => 'materials', 'uses' => 'MaterialController@openListPage'));
	Route::get('/materials/all/delete', 'MaterialController@deleteAllFilteredMaterial');
	...
	Route::get('/check-material/{id}', 'MaterialController@checkMaterial');

	/**
	 * Inventories
	 */
	Route::get('/inventories/filter', array('as' => 'inventoriesfilter', 'uses' => 'InventoryController@openFilterPage'));
	...
	Route::get('/completions/list/filter', array('as' => 'filterlistcompletions', 'uses' => 'CompletionController@openFilterListPage'));
	Route::get('/completions/list/filter/list', array('as' => 'filteredlistcompletions', 'uses' => 'CompletionController@openFilteredListPage'));
	Route::get('/completions/list/all/active', 'CompletionController@activeAllFilteredCompletion');
	Route::get('/completions/list/all/nonactive', 'CompletionController@nonactiveAllFilteredCompletion');
	Route::get('/completions/list/all/delete', 'CompletionController@deleteAllFilteredCompletion');
	...
	Route::get('/transfers/list/filter', array('as' => 'filterlisttransfers', 'uses' => 'TransferController@openFilterListPage'));
	Route::get('/transfers/list/filter/list', array('as' => 'filteredlisttrasnfers', 'uses' => 'TransferController@openFilteredListPage'));
	Route::get('/transfers/list/all/delete', 'TransferController@deleteAllFilteredTransfer');
	...
	Route::post('/repairs/add', 'RepairController@createRepairs');

	/**
	 * AfterRepair
	 */

	Route::get('/after-repairs/add', array('as' => 'addAfterRepairs', 'uses' => 'AfterRepairController@openCreatePage'));
	Route::post('/after-repairs/add', 'AfterRepairController@createRepairs');
	...
	Route::get('/archive/resume', array('as' => 'listarchiveresume', 'uses' => 'ArchiveController@openResumeListPage'));
	Route::get('/archive/error', array('as' => 'listarchiveerror', 'uses' => 'ArchiveController@openErrorListPage'));
	Route::get('/archive/resume/download/{reference_file}', array('as' => 'detailBatchoutputs', 'uses' => 'ArchiveController@downloadResume'));
	Route::get('/archive/resume/{id}', array('as' => 'detailBatchoutputs', 'uses' => 'ArchiveController@openResumeDetailPage'));
	Route::get('/archive/error/download/{reference_file}', array('as' => 'detailBatchoutputs', 'uses' => 'ArchiveController@downloadResume'));
	Route::get('/archive/error/delete/{reference_file}', 'ArchiveController@deleteError');
	Route::get('/archive/error/{id}', array('as' => 'detailBatchoutputs', 'uses' => 'ArchiveController@openErrorDetailPage'));
...
Route::group(array(
	...
	Route::get('/materials/{id}/delete', 'AjaxController@deleteMaterialJSON');
	Route::get('/completions', 'AjaxController@completionJSON');
	Route::get('/completions/{id}/delete', 'AjaxController@deleteCompletionJSON');
	Route::get('/transfers', 'AjaxController@transferJSON');
	Route::get('/transfers/{id}/delete', 'AjaxController@deleteTransferJSON');
